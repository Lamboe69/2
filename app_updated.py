...
# Load models - REQUIRE real ML models to work
...
if pipeline is None:
    st.error("Failed to load USL models. The system requires real ML models to function.")
    st.error("Please ensure model files are present and there's sufficient memory.")
    st.stop()
